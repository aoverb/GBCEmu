...
const std::unordered_map<uint8_t, Instruction> INSTRCUTION_SET = {
    ...
    {0x07, {InstType::RLCA, AddrMode::IMP}},
    {0x08, {InstType::LD, AddrMode::A16_R, RegType::NONE, RegType::SP}},
    {0x09, {InstType::ADD, AddrMode::R_R, RegType::HL, RegType::BC}},
    ...
    {0x0F, {InstType::RRCA, AddrMode::IMP}},

    {0x10, {InstType::STOP, AddrMode::IMP}},
    ...
    {0x17, {InstType::RLA, AddrMode::IMP}},
    {0x18, {InstType::JR, AddrMode::D8}},
    {0x19, {InstType::ADD, AddrMode::R_R, RegType::HL, RegType::DE}},
    ...
    {0x1F, {InstType::RRA, AddrMode::IMP}},
    ...
    {0x27, {InstType::DAA, AddrMode::IMP}},
    {0x28, {InstType::JR, AddrMode::D8, RegType::NONE, RegType::NONE, CondType::Z}},
    {0x29, {InstType::ADD, AddrMode::R_R, RegType::HL, RegType::HL}},
    ...
    {0x2F, {InstType::CPL, AddrMode::IMP}},
    ...
    {0x36, {InstType::LD, AddrMode::MR_D8, RegType::HL}},
    {0x37, {InstType::SCF, AddrMode::IMP}},
    {0x38, {InstType::JR, AddrMode::D8, RegType::NONE, RegType::NONE, CondType::C}},
    {0x39, {InstType::ADD, AddrMode::R_R, RegType::HL, RegType::SP}},
    ...
    {0x3F, {InstType::CCF, AddrMode::IMP}},
    ...
    {0x76, {InstType::HALT, AddrMode::IMP}},
    ...
    {0x80, {InstType::ADD, AddrMode::R_R, RegType::A, RegType::B}},
    {0x81, {InstType::ADD, AddrMode::R_R, RegType::A, RegType::C}},
    {0x82, {InstType::ADD, AddrMode::R_R, RegType::A, RegType::D}},
    {0x83, {InstType::ADD, AddrMode::R_R, RegType::A, RegType::E}},
    {0x84, {InstType::ADD, AddrMode::R_R, RegType::A, RegType::H}},
    {0x85, {InstType::ADD, AddrMode::R_R, RegType::A, RegType::L}},
    {0x86, {InstType::ADD, AddrMode::R_MR, RegType::A, RegType::HL}},
    {0x87, {InstType::ADD, AddrMode::R_R, RegType::A, RegType::A}},
    {0x88, {InstType::ADC, AddrMode::R_R, RegType::A, RegType::B}},
    {0x89, {InstType::ADC, AddrMode::R_R, RegType::A, RegType::C}},
    {0x8A, {InstType::ADC, AddrMode::R_R, RegType::A, RegType::D}},
    {0x8B, {InstType::ADC, AddrMode::R_R, RegType::A, RegType::E}},
    {0x8C, {InstType::ADC, AddrMode::R_R, RegType::A, RegType::H}},
    {0x8D, {InstType::ADC, AddrMode::R_R, RegType::A, RegType::L}},
    {0x8E, {InstType::ADC, AddrMode::R_MR, RegType::A, RegType::HL}},
    {0x8F, {InstType::ADC, AddrMode::R_R, RegType::A, RegType::A}},

    {0x90, {InstType::SUB, AddrMode::R_R, RegType::A, RegType::B}},
    {0x91, {InstType::SUB, AddrMode::R_R, RegType::A, RegType::C}},
    {0x92, {InstType::SUB, AddrMode::R_R, RegType::A, RegType::D}},
    {0x93, {InstType::SUB, AddrMode::R_R, RegType::A, RegType::E}},
    {0x94, {InstType::SUB, AddrMode::R_R, RegType::A, RegType::H}},
    {0x95, {InstType::SUB, AddrMode::R_R, RegType::A, RegType::L}},
    {0x96, {InstType::SUB, AddrMode::R_MR, RegType::A, RegType::HL}},
    {0x97, {InstType::SUB, AddrMode::R_R, RegType::A, RegType::A}},
    {0x98, {InstType::SBC, AddrMode::R_R, RegType::A, RegType::B}},
    {0x99, {InstType::SBC, AddrMode::R_R, RegType::A, RegType::C}},
    {0x9A, {InstType::SBC, AddrMode::R_R, RegType::A, RegType::D}},
    {0x9B, {InstType::SBC, AddrMode::R_R, RegType::A, RegType::E}},
    {0x9C, {InstType::SBC, AddrMode::R_R, RegType::A, RegType::H}},
    {0x9D, {InstType::SBC, AddrMode::R_R, RegType::A, RegType::L}},
    {0x9E, {InstType::SBC, AddrMode::R_MR, RegType::A, RegType::HL}},
    {0x9F, {InstType::SBC, AddrMode::R_R, RegType::A, RegType::A}},

    {0xA0, {InstType::AND, AddrMode::R_R, RegType::A, RegType::B}},
    {0xA1, {InstType::AND, AddrMode::R_R, RegType::A, RegType::C}},
    {0xA2, {InstType::AND, AddrMode::R_R, RegType::A, RegType::D}},
    {0xA3, {InstType::AND, AddrMode::R_R, RegType::A, RegType::E}},
    {0xA4, {InstType::AND, AddrMode::R_R, RegType::A, RegType::H}},
    {0xA5, {InstType::AND, AddrMode::R_R, RegType::A, RegType::L}},
    {0xA6, {InstType::AND, AddrMode::R_MR, RegType::A, RegType::HL}},
    {0xA7, {InstType::AND, AddrMode::R_R, RegType::A, RegType::A}},
    {0xA8, {InstType::XOR, AddrMode::R_R, RegType::A, RegType::B}},
    {0xA9, {InstType::XOR, AddrMode::R_R, RegType::A, RegType::C}},
    {0xAA, {InstType::XOR, AddrMode::R_R, RegType::A, RegType::D}},
    {0xAB, {InstType::XOR, AddrMode::R_R, RegType::A, RegType::E}},
    {0xAC, {InstType::XOR, AddrMode::R_R, RegType::A, RegType::H}},
    {0xAD, {InstType::XOR, AddrMode::R_R, RegType::A, RegType::L}},
    {0xAE, {InstType::XOR, AddrMode::R_MR, RegType::A, RegType::HL}},
    {0xAF, {InstType::XOR, AddrMode::R_R, RegType::A, RegType::A}},

    {0xB0, {InstType::OR, AddrMode::R_R, RegType::A, RegType::B}},
    {0xB1, {InstType::OR, AddrMode::R_R, RegType::A, RegType::C}},
    {0xB2, {InstType::OR, AddrMode::R_R, RegType::A, RegType::D}},
    {0xB3, {InstType::OR, AddrMode::R_R, RegType::A, RegType::E}},
    {0xB4, {InstType::OR, AddrMode::R_R, RegType::A, RegType::H}},
    {0xB5, {InstType::OR, AddrMode::R_R, RegType::A, RegType::L}},
    {0xB6, {InstType::OR, AddrMode::R_MR, RegType::A, RegType::HL}},
    {0xB7, {InstType::OR, AddrMode::R_R, RegType::A, RegType::A}},
    {0xB8, {InstType::CP, AddrMode::R_R, RegType::A, RegType::B}},
    {0xB9, {InstType::CP, AddrMode::R_R, RegType::A, RegType::C}},
    {0xBA, {InstType::CP, AddrMode::R_R, RegType::A, RegType::D}},
    {0xBB, {InstType::CP, AddrMode::R_R, RegType::A, RegType::E}},
    {0xBC, {InstType::CP, AddrMode::R_R, RegType::A, RegType::H}},
    {0xBD, {InstType::CP, AddrMode::R_R, RegType::A, RegType::L}},
    {0xBE, {InstType::CP, AddrMode::R_MR, RegType::A, RegType::HL}},
    {0xBF, {InstType::CP, AddrMode::R_R, RegType::A, RegType::A}},

    {0xC0, {InstType::RET, AddrMode::IMP, RegType::NONE, RegType::NONE, CondType::NZ}},
    {0xC1, {InstType::POP, AddrMode::R, RegType::BC}},
    ...
    {0xC5, {InstType::PUSH, AddrMode::R, RegType::BC}},
    {0xC6, {InstType::ADD, AddrMode::R_D8, RegType::A}},
    ...
    {0xD1, {InstType::POP, AddrMode::R, RegType::DE}},
    ...
    {0xD5, {InstType::PUSH, AddrMode::R, RegType::DE}},
    {0xD6, {InstType::SUB, AddrMode::R_D8, RegType::A}},
    ...
    {0xE1, {InstType::POP, AddrMode::R, RegType::HL}},
    {0xE2, {InstType::LD, AddrMode::MR_R, RegType::C, RegType::A}},
    {0xE5, {InstType::PUSH, AddrMode::R, RegType::HL}},
    {0xE6, {InstType::AND, AddrMode::R_D8, RegType::A}},
    {0xE7, {InstType::RST, AddrMode::IMP, RegType::NONE, RegType::NONE, CondType::NONE, 0x20}},
    {0xE8, {InstType::ADD, AddrMode::R_D8, RegType::SP}},
    {0xE9, {InstType::JP, AddrMode::R, RegType::HL}},
    {0xEA, {InstType::LD, AddrMode::A16_R, RegType::NONE, RegType::A}},
    {0xEE, {InstType::XOR, AddrMode::R_D8, RegType::A}},
    {0xEF, {InstType::RST, AddrMode::IMP, RegType::NONE, RegType::NONE, CondType::NONE, 0x28}},

    {0xF0, {InstType::LDH, AddrMode::R_A8, RegType::A}},
    {0xF1, {InstType::POP, AddrMode::R, RegType::AF}},
    {0xF2, {InstType::LD, AddrMode::R_MR, RegType::A, RegType::C}},
    {0xF3, {InstType::DI, AddrMode::IMP}},
    {0xF5, {InstType::PUSH, AddrMode::R, RegType::AF}},
    {0xF6, {InstType::OR, AddrMode::R_D8, RegType::A}},
    {0xF7, {InstType::RST, AddrMode::IMP, RegType::NONE, RegType::NONE, CondType::NONE, 0x30}},
    {0xF8, {InstType::LD, AddrMode::HL_SPR, RegType::HL, RegType::SP}},
    {0xF9, {InstType::LD, AddrMode::R_R, RegType::SP, RegType::HL}},
    {0xFA, {InstType::LD, AddrMode::R_A16, RegType::A}},
    {0xFB, {InstType::EI, AddrMode::IMP}},
    {0xFE, {InstType::CP, AddrMode::R_D8, RegType::A}},
